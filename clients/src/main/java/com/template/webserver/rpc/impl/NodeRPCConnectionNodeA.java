 ...
 */
@Component
public class NodeRPCConnectionNodeA extends NodeRPCConnectionNode implements AutoCloseable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NodeRPCConnectionNodeA.class);
