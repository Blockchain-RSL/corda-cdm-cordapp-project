 ...
 */
@Component
public class NodeRPCConnectionNodeC extends NodeRPCConnectionNode implements AutoCloseable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NodeRPCConnectionNodeC.class);
